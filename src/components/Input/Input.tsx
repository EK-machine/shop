...
const Input: React.FC<InputProps> = (props) => {
  const blurHandler: FocusEventHandler<HTMLInputElement> = async () => {
    ...
    >
      ...
      <input
        ...
        onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
          props.setValue(e.target?.value as (SetStateAction<string> & SetStateAction<boolean>) & SetStateAction<File>)
        }
        autoComplete="off"
